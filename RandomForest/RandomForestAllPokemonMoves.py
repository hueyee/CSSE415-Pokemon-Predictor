...
def preprocess_data(df: pd.DataFrame, target_column):
    ...
    if USE_PREVIOUS_POKEMON:
        features.extend([
            ...
            'p1_pokemon6_name',
            'p2_pokemon1_name', 'p2_pokemon2_name', 'p2_pokemon3_name', 'p2_pokemon4_name', 'p2_pokemon5_name',
            'p2_pokemon6_name',
        ])
    ...
    if USE_MOVES:
        features.extend([
            'p1_pokemon1_move1', 'p1_pokemon1_move2', 'p1_pokemon1_move3', 'p1_pokemon1_move4',
            'p1_pokemon2_move1', 'p1_pokemon2_move2', 'p1_pokemon2_move3', 'p1_pokemon2_move4',
            'p1_pokemon3_move1', 'p1_pokemon3_move2', 'p1_pokemon3_move3', 'p1_pokemon3_move4',
            'p1_pokemon4_move1', 'p1_pokemon4_move2', 'p1_pokemon4_move3', 'p1_pokemon4_move4',
            'p1_pokemon5_move1', 'p1_pokemon5_move2', 'p1_pokemon5_move3', 'p1_pokemon5_move4',
            'p1_pokemon6_move1', 'p1_pokemon6_move2', 'p1_pokemon6_move3', 'p1_pokemon6_move4',
            'p2_pokemon1_move1', 'p2_pokemon1_move2', 'p2_pokemon1_move3', 'p2_pokemon1_move4',
            'p2_pokemon2_move1', 'p2_pokemon2_move2', 'p2_pokemon2_move3', 'p2_pokemon2_move4',
            'p2_pokemon3_move1', 'p2_pokemon3_move2', 'p2_pokemon3_move3', 'p2_pokemon3_move4',
            'p2_pokemon4_move1', 'p2_pokemon4_move2', 'p2_pokemon4_move3', 'p2_pokemon4_move4',
            'p2_pokemon5_move1', 'p2_pokemon5_move2', 'p2_pokemon5_move3', 'p2_pokemon5_move4',
            'p2_pokemon6_move1', 'p2_pokemon6_move2', 'p2_pokemon6_move3', 'p2_pokemon6_move4',
        ])
    ...
    categorical_features = processed_df.select_dtypes(include=['category']).columns.tolist()
